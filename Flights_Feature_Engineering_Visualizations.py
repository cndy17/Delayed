...
plt.subplot(1, 2, 1)
sns.barplot(y=top_positive.index, x=top_positive['Coefficient'], palette='Greens_d')
...
plt.subplot(1, 2, 2)
sns.barplot(y=top_negative.index, x=top_negative['Coefficient'], palette='Reds_d')
plt.title('Top 10 Negative Influential Features')
plt.xlabel('Coefficient')
plt.ylabel('Feature')
